...
#define PIN2_IDX                         2u   /*!< Pin number for pin 4 in a port */
#define PIN3_IDX                         3u   /*!< Pin number for pin 5 in a port */
...
void BOARD_InitPins_ri5cy(void)
{
    ...
    PORT_SetPinMux(PORTB, PIN2_IDX, kPORT_MuxAsGpio);            /* PORTB4 (pin C2) is configured as LPSPI0_SCK */
